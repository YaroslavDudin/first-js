...
6. Теперь переключитесь на ветку main командой __git checkout main__ и запульте изменения к себе, а потом создайте новую ветку для следующего задания и приступайте к нему :)g
